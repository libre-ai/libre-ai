...
Statut affiché : les 10 blocs portent `criteria_status: draft-pending-owner` — des brouillons dérivés des audits de parité et des cahiers des charges verrouillés, en attente de ratification propriétaire. Tant que ce statut n'a pas basculé à `owner-ratified`, ces critères sont des propositions, pas des engagements.
