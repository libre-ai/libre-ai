...
| [`bfc9e4c`](bfc9e4c/) | cinq passes après ADR-0006 et matrice physique fraîche | **REJECT global** | classe 32+ Gio requise passée sur trois moteurs ; 8/16–24 Gio devenues contributions facultatives non supportées ; seul l'OOM processus trois moteurs reste bloquant |
| [`9ee3f8d`](9ee3f8d/) | six passes après ADR-0007 et attribution RSS verrouillée | **APPROVE Gate B** | cinq rôles approuvent ; host exact, fautes, `ENOSPC`, classe 32+ Gio et budgets passent ; OOM et 8/16–24 Gio restent facultatifs ; activation/release séparées |
