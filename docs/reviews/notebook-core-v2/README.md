...
Statut : **locked / Gate A approuvée / quatre passes Gate B rejetées / release bloquée**.
...
L’artefact WASM et son composant transpillé ont des imports vides ; les copies ABI, buffers host et instances jetables après fautes injectées sont exercés dans trois navigateurs. Le host produit, les OOM/panic internes et la matrice performances/appareils restent à qualifier.
