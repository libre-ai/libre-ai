...
the reviewer to a distinct agent/session under [`AGENT-REVIEW-PROTOCOL.md`](../docs/reviews/AGENT-REVIEW-PROTOCOL.md). Uncataloged files and missing authorities fail `bun run check:contracts`.
