...
- the shared `engine-golden-vectors-v1` remains candidate: successive integration/Security passes invalidated earlier approvals on mixed, named, quoted, EAI/IDN/CFWS and resource-pathological email cases; the bounded parser remediation still requires fresh candidate-integration, Architecture and Security passes ;
