...
- the shared `engine-golden-vectors-v1` remains candidate: successive integration/Security passes invalidated earlier approvals through RFC 6532 EAI, prose boundaries, generic URI userinfo and private-key markers; fresh candidate-integration, Architecture and Security passes remain required ;
