...
- agent orchestration option B reaches contract Specification Lock after Architecture/Security/France-EU Privacy reviews, a remediated actual-Biscuit candidate-integration and catalog-only promotion of 14 unchanged authorities; simulation-only `WP-G2-A01` has favorable Architecture/Security/France-EU Privacy definition reviews and is schedulable, Pi remains replaceable and no harness, worker launch or real mission is authorized ;
