...
- the shared `engine-golden-vectors-v1` remains candidate: approvals on `ae455b9`/`79d02b6` were invalidated by mixed, named, semicolonless and quoted email-encoding findings, now under bounded remediation before fresh Architecture and Security passes ;
