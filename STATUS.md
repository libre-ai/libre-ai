...
- the shared `engine-golden-vectors-v1` remediation is approved by fresh Architecture and Security passes on `ae455b9`, but remains candidate pending evidence integration, owner control and a distinct catalog-only promotion ;
