...
- the shared `engine-golden-vectors-v1` remains candidate: candidate-integration approved the combined IPv6/ASCII-metadata/wrapped-CFWS merge `ccf9d68`; fresh Architecture/Security passes and explicit owner dependency acceptance remain required ;
