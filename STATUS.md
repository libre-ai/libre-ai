...
- the shared `engine-golden-vectors-v1` remains candidate: the approvals recorded on `ae455b9` were invalidated by a later mixed-HTML bypass finding, which is under bounded remediation before fresh Architecture and Security passes ;
