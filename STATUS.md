...
- the shared `engine-golden-vectors-v1` remains candidate: successive integration/Security passes invalidated earlier approvals through RFC 6532 EAI, prose boundaries, generic URI userinfo, private-key markers and a schema/scanner metadata drift; fresh candidate-integration, Architecture and Security passes remain required ;
